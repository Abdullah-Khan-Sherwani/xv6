...
#define LEVELS   3 // ADDED BY SAFEGUARD. Number of levels in the page table
#define IDXBITS  9 // ADDED BY SAFEGUARD. Number of bits used for each level
#define PGOFF    12 // ADDED BY SAFEGUARD. Number of bits used for the page offset
